...
try:
    ...
    print("In order to achieve operational capability, this programme requires hyperopt to be installed (pip install "
          "hyperopt), unless you make get_params() use something else.")
